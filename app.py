...
def main():
    ...
    with col1:
        ...
        # selected_languages = [lang[0] for lang in languages]
    ...
    if generate_button:
        # Save uploaded brief temporarily with correct extension
        # Preserve the original file extension (json or yaml/yml)
        ...
        with progress_container:
            ...
            try:
                ...
                # Handle different possible structures of output_dir
                ...
                # ⭐ MAIN FEATURE: Display generated images in UI
    ...
    # Sidebar stats (if campaigns exist)
